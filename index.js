...
function getHotelsByPrice(hotels, order) {
  ...
  if (order === 'low-to-high') {
    ...
    return copyHotels.sort((a, b) => b.price - a.price);
  }
}
...
function getHotelsByRating(hotels, order) {
  ...
  if (order === 'low-to-high') {
    ...
    return copyHotels.sort((a, b) => b.rating - a.rating);
  }
}
...
function getHotelsByReviews(hotels, order) {
  ...
  if (order === 'least-to-most') {
    ...
    return copyHotels.sort((a, b) => b.reviews - a.reviews);
  }
}
...
function filterHotelsByAmenity(hotels, amenity) {
  return hotels.filter((ele) => ele.amenity.toLowerCase() === amenity);
}
...
function filterHotelsByCountry(hotels, country) {
  return hotels.filter((ele) => ele.country.toLowerCase() === country);
}
...
function filterHotelsByCategory(hotels, category) {
  return hotels.filter((ele) => ele.category.toLowerCase() === category);
}
